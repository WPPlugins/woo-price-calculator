<div id="checkbox_options" style="display: none;width: 100%">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input class="form-control wpc-numeric-decimals" name="checkbox_check_value" type="text" value="<?php echo $this->view['form']['checkbox_check_value']; ?>" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input class="form-control wpc-numeric-decimals" name="checkbox_uncheck_value" type="text" value="<?php echo $this->view['form']['checkbox_uncheck_value']; ?>" />
        </div>
    </div>
</div>
